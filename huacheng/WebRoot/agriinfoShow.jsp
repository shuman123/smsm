...
<html>
  <head>
   <script type="text/javascript">
        ...
        document.getElementById("important").innerHTML="热门搜索：焦点新闻、行情动态、每周评述";
    }
     function NOLight(id){
     ...
     <div id="wrap">
       	...
       	<div id="main">
       		...
       		<div id="main-center">
       		 <div class="s">
       		 <div class="type1">
       		 <form name="f1" action="AgriinfoByTypeServelet" method="post">
       		     类别：<input type="text"  name="agriinfType" onfocus="hightLight('important')" onblur="NOLight('important')" class="typestyle"/>
       		 ...
       		 <div id="important"></div>
       			...
       			<tr>
       			        <td class="titleword">图片</td>
       			        <td class="titleword">标题</td>
       			        <td class="titleword">收藏</td>
       			</tr>
     			<c:forEach var="agriinfo" items="${agriinfoList}" varStatus="varIndex" >
				<tr>
						<td width="15%"><a href="DetailServlet?id=${agriinfo.aId }"><img src="${agriinfo.aimageUrl }"  class="imagestyle"/></a></td>
						<td width="70%" class="atitle"><a href="DetailServlet?id=${agriinfo.aId }">${agriinfo.atitle }</a></td>
						<td width="25%" class="image1"><a href="CollectAgriinfoServlet?id=${agriinfo.aId }"><img src="images/agrimages/collect.png" width="25" height="25"></a>
				</tr>
			</c:forEach>
       			<tr align="center" class="pagestyle">
               <td colspan="3">
               <!-- 
                <a href="AgriinfoServlet?how=1">首页</a>
               <c:forEach var="page" items="${pagecounts}">
       		   <a href="AgriinfoServlet?how=${page}">第${page}页</a>
       		   </c:forEach>
       		   <a href="AgriinfoServlet?how=${fn:length(pagecounts)}">尾页</a>
       		       共有【${fn:length(pagecounts)}】页
                -->
              <a href="AgriinfoServlet?showpage=1">首页</a> 
       		  <a href="AgriinfoServlet?showpage=${showpage-1}" >上一页</a>
       		  <a href="AgriinfoServlet?showpage=${showpage+1}" >下一页</a>
       		  <a href="AgriinfoServlet?showpage=${pagecount }" >尾页</a>
       		    共有【${pagecount }】页
...
<td ><a href="DetailServlet?id=${topfive.aId }">${topfive.atitle }</a></td>
 	...
 	<div id="weatherbox">
       			  <div class="w1">
       			  <form name="wf" action="AgriinfoServlet" method="post">
