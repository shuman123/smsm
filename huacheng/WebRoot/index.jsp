       	...
       	<div id="main">
       		<div id="main-left">
       			...
       			<td ><a href="ProductServlet">全部</a></td>
       				...
       				<tr>
       					<td>
                        <a href="SearchproductServlet?ptypeName=零食">零食</a><br/>
       					<span>糖果</span>
       					<span>梅子干</span>
       					<span>薯条</span>
       					</td>
...
<div class="Menubox">
<ul>
<li id="one1" onclick="setTab(1)">蔬菜</li>
<li id="one2" onclick="setTab(2)">干果</li>
<li id="one3" onclick="setTab(3)">菌类</li>
<li id="one4" onclick="setTab(4)">鲜果</li>
<li id="one5" onclick="setTab(5)">谷类</li>
</ul>
</div>
<div id="contentbox">
